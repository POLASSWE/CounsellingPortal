...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      {/* Header */}
      <header className="bg-white border-b border-sidebar-border sticky top-0 z-40">
      ...
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside className="w-64 bg-white border-r border-sidebar-border hidden md:block">
              ...
              return (
                <Button
                  ...
                  className={cn(
                    ...
                    isActive && "bg-sidebar-accent font-semibold text-white"
                  )}
